<nav class="bg-white/95 glass border-b border-gray-100 sticky top-0 z-50 shadow-sm">
    <div class="container mx-auto px-4">
                        ...
                        <form action="{{ route('search') }}" method="GET">
                            <div class="relative">
                                <input type="text" name="q" placeholder="Cari berita..."
                                    ...
                                    x-ref="searchInput" @keydown.enter="$el.form.submit()">
                            ...
                            <button type="submit"
                                class="w-full mt-2 px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors">
                                Cari
                            </button>
                        </form>
                    </div>
        ...
        {{-- Mobile Navigation --}}
        <div x-data="{ open: false }" x-on:toggle-mobile-menu.window="open = !open" x-show="open" x-collapse
