<div class="space-y-8">
    {{-- Search Header --}}
    <div class="text-center py-8 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl">
    ...
    <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <article class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow group">
                    <a href="{{ route('article.show', $article->slug) }}" class="block">
                        ...
                        <div class="p-5">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-700 mb-2">
                                {{ $article->category->name ?? 'Uncategorized' }}
                            </span>
                            <h3 class="text-lg font-semibold text-gray-900 line-clamp-2 group-hover:text-indigo-600 transition-colors mb-2">
                                {{ $article->title }}
                            </h3>
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 text-lg">Tidak ada hasil untuk "<span class="font-semibold">{{ $query }}</span>"</p>
