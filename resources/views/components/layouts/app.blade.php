            ...
            <div class="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-1">
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed mb-4">
                        Sumber informasi terpercaya yang menyajikan berita terkini, akurat, dan berimbang dari berbagai
                        bidang.
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-gray-400 text-sm">Jl. Contoh Alamat No. 123, Jakarta, Indonesia</span>
                        </li>
                        <li class="flex items-center gap-3">
                            ...
                            <a href="mailto:info@portalberita.com"
                                class="text-gray-400 hover:text-indigo-400 transition-colors text-sm">info@portalberita.com</a>
                        </li>
                        <li class="flex items-center gap-3">
                            <svg class="w-5 h-5 text-indigo-400 shrink-0" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                            ...
                            <a href="tel:+62123456789"
                                class="text-gray-400 hover:text-indigo-400 transition-colors text-sm">+62 123 456
                                789</a>
                        </li>
                    </ul>
                </div>
